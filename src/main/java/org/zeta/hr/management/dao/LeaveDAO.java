...
public class LeaveDAO {
  ...
  public List<Leave> getEmployeeLeaves () {
    ...
    try {
      connection = DatabaseManager.getConnection();
      preparedStatement = connection.prepareStatement(LeaveConstants.SELECT_LEAVES_BY_UNDER_AN_EMPLOYEE_QUERY);
      resultSet = preparedStatement.executeQuery();
      while (resultSet.next()) {
        leaves.add(
            new Leave(
  ...
  public List<Leave> getLeavesByStatus(LeaveStatus status) {
    ...
    try {
      connection = DatabaseManager.getConnection();
      preparedStatement =
          connection.prepareStatement(LeaveConstants.SELECT_LEAVES_BY_UNDER_AN_EMPLOYEE_QUERY_PENDING_STATUS);
